...
var slider = $.widget( "ui.slider", $.ui.mouse, {
	...
	options: {
		...
		value: 0,
		values: null,
		rtl: false, // ✅ جدید: پشتیبانی راست‌چین
	...
	_normValueFromMouse: function( position ) {
		...
		/* این خط اضافه شد */
		if ( this.options.rtl && this.orientation === "horizontal" ) {
			percentMouse = 1 - percentMouse;  // ✅ جهت را برعکس می‌کنیم
		}
		...
		if ( this.options.values && this.options.values.length ) {
			this.handles.each(function( i ) {
				...
				if (that.orientation === "horizontal") {
					if (that.options.rtl) {
						_set["right"] = valPercent + "%"; // ✅ برای حالت راست‌چین
					} else {
						_set["left"] = valPercent + "%";
					}
				} else {
					_set["bottom"] = valPercent + "%";
				}
